...
?>
        ...
        <!-- Hero Section Start -->
        <section class="hero-section fix hero-1 bg-cover" style="background-image: url('<?php echo get_template_directory_uri();?>/assets/img/hero/hero-bg.jpg');">
            <div class="mike-shape">
                <img src="<?php echo get_template_directory_uri();?>/assets/img/hero/mike-shape.png" alt="img">
            </div>
            <div class="arrow-shape">
                <img src="<?php echo get_template_directory_uri();?>/assets/img/hero/arrow-shape.png" alt="img">
            </div>
            <div class="arrow-shape-2">
                <img src="<?php echo get_template_directory_uri();?>/assets/img/hero/arrow-shape.png" alt="img">
            </div>
            <div class="energy-shape float-bob-y">
                <img src="<?php echo get_template_directory_uri();?>/assets/img/hero/energy-shape.png" alt="img">
            </div>
            <div class="rocket-shape">
                <img src="<?php echo get_template_directory_uri();?>/assets/img/hero/rocket.png" alt="img" class="float-bob-y">
            </div>
            <div class="container-fluid">
                <div class="hero-title wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
                    <img src="<?php echo get_template_directory_uri();?>/assets/img/hero/hero-text.png" alt="img">      
                </div>
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="hero-image">
                            <img src="<?php echo get_template_directory_uri();?>/assets/img/hero/hero-image.png" alt="img" class=" wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
                            <div class="bg-shape">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/hero/bg-shape.png" alt="img">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-6">
                        <div class="video-right">
                            <a href="https://www.youtube.com/watch?v=Cn4G2lZ_g2I" class="video-btn video-popup wow fadeInUp" data-wow-delay=".3s">
                                ...
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/hero/text-circle.png" alt="img">
                            </a>
                            ...
                            <div class="client-items wow fadeInUp" data-wow-delay=".7s">
                                <div class="client-logo">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/hero/logo.png" alt="img">
                                </div>
                                <div class="client-img">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/hero/client.png" alt="img">
                                    <div class="star-icon">
                                        <div class="star">
        ...
        <div class="marquee-section-1">
            <div class="mycustom-marque style-2">
                <div class="scrolling-wrap">
                    <div class="comm">
                        <div class="cmn-textslide"><img src="<?php echo get_template_directory_uri();?>/assets/img/star.png" alt="img">THE BEST SOULTION</div>
                        <div class="cmn-textslide"><img src="<?php echo get_template_directory_uri();?>/assets/img/star.png" alt="img">THE BEST SOULTION</div>
                        <div class="cmn-textslide"><img src="<?php echo get_template_directory_uri();?>/assets/img/star.png" alt="img">THE BEST SOULTION</div>
                        <div class="cmn-textslide"><img src="<?php echo get_template_directory_uri();?>/assets/img/star.png" alt="img">THE BEST SOULTION</div>
                        <div class="cmn-textslide"><img src="<?php echo get_template_directory_uri();?>/assets/img/star.png" alt="img">THE BEST SOULTION</div>
        ...
        <section class="service-section fix section-padding">
            <div class="left-shape float-bob-y">
                <img src="<?php echo get_template_directory_uri();?>/assets/img/service/left-shape.png" alt="img">
            </div>
            <div class="right-shape">
                <img src="<?php echo get_template_directory_uri();?>/assets/img/service/right-shape.png" alt="img">
            </div>
            <div class="bg-shape">
                <img src="<?php echo get_template_directory_uri();?>/assets/img/service/bg-shape.png" alt="img">
            </div>
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="service-box-items">
                            <div class="icon">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/service/icon-1.png" alt="img">
                            </div>
                            <div class="content"> 
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="service-box-items">
                            <div class="icon">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/service/icon-2.png" alt="img">
                            </div>
                            <div class="content"> 
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                        <div class="service-box-items">
                            <div class="icon">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/service/icon-3.png" alt="img">
                            </div>
                            <div class="content"> 
        ...
        <!-- About Section Start -->
        <section class="about-section fix section-padding" style="background-image: url('<?php echo get_template_directory_uri();?>/assets/img/about/about-bg.png');">
            <div class="left-shape float-bob-y">
                <img src="<?php echo get_template_directory_uri();?>/assets/img/about/left-shape.png" alt="img">
            </div>
            <div class="container">
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="about-image">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/about/01.png" alt="img" class="wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
                                <div class="bg-shape">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/about/bg-shape.png" alt="img">
                                </div>
                                <div class="grap-shape float-bob-x">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/about/grap.png" alt="img">
                                </div>
                                <div class="box-shape float-bob-y">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/about/box-shape.png" alt="img">
                                </div>
                                <div class="emoji-shape">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/about/emoji.png" alt="img">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
        ...
        <section class="case-study-section fix section-padding">
            <div class="overlay-shape">
                <img src="<?php echo get_template_directory_uri();?>/assets/img/case-studies/overlay-shape.png" alt="img">
            </div>
            <div class="left-shape float-bob-x">
                <img src="<?php echo get_template_directory_uri();?>/assets/img/case-studies/left-shape.png" alt="img">
            </div>
            <div class="right-shape float-bob-x">
                <img src="<?php echo get_template_directory_uri();?>/assets/img/case-studies/right-shaape.png" alt="img">
            </div>
            <div class="container">
                <div class="section-title-area">
                    <div class="section-title">
                    ...
                    <div class="row">
                        <div class="col-xxl-6 wow fadeInUp">
                            <div class="case-study-box-items">
                                <div class="thumb">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/case-studies/01.jpg" alt="img">
                                    ...
                                    <h3 class="project-title">
                                        <a href="project-details.html">
                                            <img src="<?php echo get_template_directory_uri();?>/assets/img/case-studies/icon.png" alt="img">
        ...
        <section class="audience-section fix section-padding bg-cover" style="background-image: url('<?php echo get_template_directory_uri();?>/assets/img/audience-bg.jpg');">
            <div class="container">
                        ...
                        <div class="col-lg-8">
                            <div class="audience-right">
                                <div class="audience-img wow fadeInUp" data-wow-delay=".3s">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/audience-img.jpg" alt="img">
                                </div>
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="team-image">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/team/01.png" alt="img" class="wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
                                <div class="shape-image">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/team/shape-img.png" alt="img">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
        ...
        <section class="pricing-section fix section-padding section-bg">
            <div class="left-shape float-bob-y">
                <img src="<?php echo get_template_directory_uri();?>/assets/img/pricing-left.png" alt="img">
            </div>
            <div class="right-shape float-bob-y">
                <img src="<?php echo get_template_directory_uri();?>/assets/img/pricing-right.png" alt="img">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-4">
                        <div class="pricing-content">
                            ...
                            <div class="pricing-tab-header mt-4 mt-md-0">
                                <div class="arrow-shape">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/arrow.png" alt="img">
                                </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                                        <div class="pricing-box-items">
                                            <div class="pricing-header">
                                                ...
                                                <div class="icon">
                                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/cloud.png" alt="img">
                                                </div>
                                            </div>
                                            <ul class="price-list">
                                                <li>
                    ...
                    <div class="row">
                        <div class="col-xl-2 col-lg-4">
                            <div class="testimonial-left wow fadeInUp" data-wow-delay=".3s">
                                <div class="client-img">
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/testimonial/10.png" alt="img">
                                    <div class="content">
                                        <div class="star">
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="testimonial-box-items">
                                            ...
                                            <div class="testimonial-img">
                                                <img src="<?php echo get_template_directory_uri();?>/assets/img/testimonial/01.png" alt="img">
                                                <div class="shape-img">
                                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/testimonial/shape.png" alt="img">
                                                </div>
                                            </div>
                                            <div class="content">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-box-items">
                                            ...
                                            <div class="testimonial-img">
                                                <img src="<?php echo get_template_directory_uri();?>/assets/img/testimonial/02.png" alt="img">
                                                <div class="shape-img">
                                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/testimonial/shape.png" alt="img">
                                                </div>
                                            </div>
        ...
        <section class="news-section section-padding section-bg">
            <div class="left-shape">
                <img src="<?php echo get_template_directory_uri();?>/assets/img/news/left-shape.png" alt="img">
            </div>
            <div class="container">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="news-box-items">
                            <div class="news-image wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.2s">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/news/01.jpg" alt="img">
                            </div>
                            <div class="news-content">
                                ...
                                <div class="news-btn">
                                    ...
                                    <img src="<?php echo get_template_directory_uri();?>/assets/img/news/client-img.png" alt="img">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="news-box-items">
                            <div class="news-image wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.4s">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/news/02.jpg" alt="img">
                            </div>
                            <div class="news-content">
                                <ul class="post-cat">
                                    <li>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="news-box-items">
                            <div class="news-image wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.6s">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/news/03.jpg" alt="img">
                            </div>
                            <div class="news-content">
                                <ul class="post-cat">
                                    <li>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="news-box-items">
                            <div class="news-image wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.8s">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/news/04.jpg" alt="img">
                            </div>
                            <div class="news-content">
                                <ul class="post-cat">
                                    <li>
        ...
        <section class="cta-section section-bg section-padding pb-0">
            ...
            <div class="container">
                <div class="cta-wrapper bg-cover" style="background-image: url('<?php echo get_template_directory_uri();?>/assets/img/cta-bg.jpg');">
                    <div class="cta-img wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
                        <img src="<?php echo get_template_directory_uri();?>/assets/img/cta-img.png" alt="img">
                    </div>
                    <h2 class="wow fadeInUp" data-wow-delay=".3s">
